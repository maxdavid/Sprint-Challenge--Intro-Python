...
print("Starts with D:")
a = [human.name for human in humans if human.name[0].casefold() == "d"]
print(a)

# Write a list comprehension that creates a list of names of everyone
# whose name ends in "e".
print("Ends with e:")
b = [human.name for human in humans if human.name[-1].casefold() == "e"]
print(b)

# Write a list comprehension that creates a list of names of everyone
# whose name starts with any letter between 'C' and 'G' inclusive.
print("Starts between C and G, inclusive:")
c = [human.name for human in humans if match(r"^[c-g]", human.name.casefold())]
print(c)
